...
exports.smsg = (conn, m, hasParent) => {
     ...
     */
     m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Simple Bot Whatsapp', body: wm, sourceUrl: 'https://chat.whatsapp.com/JOZ7tfg1vFTHHGtCcQ0uYw', thumbnail: data }}, options })
    }
